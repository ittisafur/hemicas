	...
	=========================================================================*/
        if ($(".xs-demoFeed").length > 0) {
            $.fn.spectragram.accessData = {
                accessToken:
                    "1764162550.ba4c844.679392a432894982bf6a31ec20d8acb0",
	 ...
	 =====================================================*/
        ...
        if (typeof Storage != "undefined") {
            ...
            if (color != null) {
                ...
                $(".colors_panel > a[data-val=" + color + "]").addClass(
                    "active"
                );
            }
        }
	 ...
	 =====================================================*/
        if ($("#xs-contact-form").length > 0) {
            $("#xs-contact-form").on("submit", function(event) {
                ...
                if (message.val() === "") {
                    error = true;
                    message.parent().addClass("invaild");
                    message.focus();
                    return false;
                } else {
                    message.parent().removeClass("invaild");
                }
                ...
                if (error === false) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            submit
                                .after(
                                    '<h3 class="xpeedStudio_success_message">' +
                        ...
                        error: function(
                            ...
                            submit
                                .after(
                                    '<h3 class="xpeedStudio_error_message">' +
                                        "Error!!Please try again." +
                                        "</h3>"
                                )
                                .fadeIn();
                            setTimeout(() => {
                                $(".xpeedStudio_error_message").fadeOut();
                            }, 5000);
                        }
                    });
                }
...
======================================================================*/
    ...
    //     if (
    //         $("#xs-multiple-map-1").length > 0 &&
    //         $("#xs-multiple-map-2").length > 0 &&
    //         $("#xs-multiple-map-3").length > 0
    //     ) {
    ...
    //                 document.getElementById("xs-multiple-map-1"),
    //                 myOptions
    //             ),
    //             map2 = new google.maps.Map(
    //                 document.getElementById("xs-multiple-map-2"),
    //                 myOptions2
    //             ),
    //             map3 = new google.maps.Map(
    //                 document.getElementById("xs-multiple-map-3"),
    //                 myOptions3
    //             );
