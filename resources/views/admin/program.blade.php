...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <!-- END PAGE TITLE -->
            <a href="{{ url('admin/program/create')}}" class="btn btn-primary pull-right">Create new program</a>
        </div>
        <!-- END PAGE HEAD-->
        ...
        <div class="portlet light bordered">
            <div class="portlet-body form">
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="program">
                    <thead>
                        <tr>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr id="del-{{$program->id}}">
                            ...
                            <td>
                                <div class="success"></div>
                                <a class="view btn btn-circle btn-sm btn-primary" id="1" data-toggle="modal" data-target="#myModal" src="{{url(Path::programs() . $program->image)}}">
                            ...
                            <td>
                                <a href={{ url("admin/program/$program->id/edit")}} class="btn btn-outline btn-circle btn-sm purple">
