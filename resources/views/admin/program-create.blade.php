...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/program')}}">Program</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="{{ url('admin/program/store')}}" method="POST" class="form-horizontal" enctype='multipart/form-data'>
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="slim" data-size="350,230">
                                    <input type="file" name="programImage[]" required="">
                                </div>
                            </div>
                        </div>
